...
ItemVO _$ItemVOFromJson(Map<String, dynamic> json) => ItemVO(
      ...
      brand: json['brand'] == null
          ? null
          : ItemBrandVO.fromJson(json['brand'] as Map<String, dynamic>),
      category:
          ItemCategoryVO.fromJson(json['category'] as Map<String, dynamic>),
      genres: (json['genres'] as List<dynamic>)
          .map((e) => ItemGenreVO.fromJson(e as Map<String, dynamic>))
          .toList(),
